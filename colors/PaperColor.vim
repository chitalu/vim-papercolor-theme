...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
  ...
  call s:HL("Include", s:red, "", "italic")
  ...
  call s:HL("cFunction", s:blue, "", "italic")
  call s:HL("cTodo", s:comment, "", "bold")
  call s:HL("cStructure", s:blue, "", "italic")
  call s:HL("cCustomParen", s:foreground, "", "")
  call s:HL("cCustomFunc", s:aqua, "", "italic")
  call s:HL("cUserFunction",s:blue, "", "italic")
  call s:HL("cOctalZero", s:purple, "", "")

  " CPP highlighting
  call s:HL("cppBoolean", s:navy, "", "")
  call s:HL("cppSTLnamespace", s:purple, "", "")
  call s:HL("cppSTLconstant", s:green, "", "bold")
  call s:HL("cppSTLtype", s:pink, "", "")
  call s:HL("cppSTLexception", s:red, "", "")
  call s:HL("cppSTLfunctional", s:foreground, "", "italic")
  call s:HL("cppSTLiterator", s:pink, "", "")
  call s:HL("cppSTLfunction", s:aqua, "", "italic")
  call s:HL("cppExceptions", s:red, "", "")
  call s:HL("cppStatement", s:blue, "", "")
  call s:HL("cppStorageClass", s:navy, "", "")
  call s:HL("cppAccess",s:blue, "", "italic")
